<html lang="en">
  ...
  <body style="background-image: url('../imges/Background.jpg');background-size: 100% 100%;background-attachment: fixed;">
    <div class="container-fluid">
        ...
        <div class="row">
                <div class="col-lg-5">
                    <img class="img-fluid" src="../imges/assasin.jpg">
                </div>
                <div class="col-lg-7">
                    <br><br>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <label class="label"><b> Product Code:</b></label>
                        </div>
                        <div class="col-lg-9">
                            <p>ASSS55Jdd39</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <label class="label"><b> Game in Stock:</b></label>
                        </div>
                        <div class="col-lg-9">
                            <p>Yes</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <label class="label"><b> Game Size:</b></label>
                        </div>
                        <div class="col-lg-9">
                            <p>22 GB</p>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-lg-3">
                            <label class="label"><b> Game Genres:</b></label>
                        </div>
                        <div class="col-lg-9">
                            <p>Action, Open World, Parkour, Adventure</p>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="row">
            ...
            <p>
                Assassin’s Creed® 2 is the follow-up to the title that became the fastest-selling new IP in video game history. The highly anticipated title features a new hero, Ezio Auditore da Firenze, a young Italian noble, and a new era, the Renaissance.<br>Assassin’s Creed 2 retains the core gameplay experience that made the first opus a resounding success and features new experiences that will surprise and challenge players.<br>Assassin’s Creed 2 is an epic story of family, vengeance and conspiracy set in the pristine, yet brutal, backdrop of a Renaissance Italy. Ezio befriends Leonardo da Vinci, takes on Florence’s most powerful families and ventures throughout the canals of Venice where he learns to become a master assassin.
                    <li>EZIO, A NEW ASSASSIN FOR A NEW ERA Ezio Auditore da Firenze is a young Italian noble who will learn the ways of the assassins after his family was betrayed and he looks to seek vengeance. He is a lady’s man, a free soul with panache yet has a very human side to his personality. Through him, you become a master assassin.</li>
                    <li>RENAISSANCE ITALY Italy in the 15th century was less a country and more a collection of city-states where families with political and economic strength began to take leadership roles in cities like Florence and Venice. This journey through some of the most beautiful cities in the world takes place in a time in history where culture and art were born alongside some of the most chilling stories of corruption, greed and murder.</li>
                    <li>A NEW-FOUND FREEDOM You will be able to perform missions when you want and how you want in this open-ended world that brings back free-running and adds elements such as swimming and even flying to the adventure. The variety in gameplay adds another layer for you to truly play through the game any way you choose.</li>
                    <li>DYNAMIC CROWD Discover a living, breathing world where every character is an opportunity for the player. Blending in with the crowd is easier, working with in-game characters provide ample rewards but can also lead to surprising consequences.</li>
                    <li>BECOME A MASTER ASSASSIN Perfect your skills to become a master assassin where you brandish new weapons, learn to disarm enemies then use their weapons against them, and assassinate enemies using both hidden blades.</li>
                    <br>Please note that as of November 19th, 2018, the online features for this game are no longer supported. The Multiplayer mode / Co-op mode will no longer be accessible.(MAC ONLY)
            </p>
            </div>
