...
s
        ...
        <div class="row">
                <div class="col-lg-5">
                    <img class="img-fluid" src="../imges/tekken.jpg">
                </div>
                <div class="col-lg-7">
                    <br><br>
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-9">
                            <p>Fighting, Action, Multiplayer, Competitive</p>
                        </div>
                    </div>
                </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-10 offset-lg-1">
                ...
                <hr>
            <p>
                Discover the epic conclusion of the Mishima clan and unravel the reasons behind each step of their ceaseless fight. Powered by Unreal Engine 4, TEKKEN 7 features stunning story-driven cinematic battles and intense duels that can be enjoyed with friends and rivals alike through innovative fight mechanics.<br>Love, Revenge, Pride. Everyone has a reason to fight. Values are what define us and make us human, regardless of our strengths and weaknesses. There are no wrong motivations, just the path we choose to take.<br>Expand your fighter's journey by purchasing the Tekken 7 Season Pass separately and gain access to stunning additional content
            </p>
            </div>
